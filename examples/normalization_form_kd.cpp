/**
 * \page normalization_form_kd Example: Normalize a utf8 string in form D
 *
 * This example covers the usage of u5e::filter with
 * u5e::normalization_form_kd in order to normalize a utf8 string.
 *
 * \code
...
int main(int argc, char **argv) {
  ...
  for (int i = 1; i < argc; i++) {
    ...
    u5e::filter(input.grapheme_begin(), input.grapheme_end(), output,
                u5e::normalization_form_kd<u5e::utf8_string>);
