...
TEST(t_009_canonical_decomposition_mapping, no_decomposition) {
  int const * decomposed =
    u5e::props::canonical_decomposition_mapping::resolve(191);
  ASSERT_EQ(NULL, decomposed);
};

TEST(t_009_canonical_decomposition_mapping, multiple_chars) {
  int const * decomposed =
    u5e::props::canonical_decomposition_mapping::resolve(192);
...
TEST(t_009_canonical_decomposition_mapping, single_chars) {
  int const * decomposed =
    u5e::props::canonical_decomposition_mapping::resolve(195101);
